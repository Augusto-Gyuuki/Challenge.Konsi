...
namespace Challenge.Konsi.Tests.Unit.Architecture;

public sealed class ArchitectureTests
{
    private const string DOMAIN_NAMESPACE = "Challenge.Konsi.Domain";
    private const string APPLICATION_NAMESPACE = "Challenge.Konsi.Application";
    private const string INFRASTRUCTURE_NAMESPACE = "Challenge.Konsi.Infrastructure";
    private const string PRESENTATION_NAMESPACE = "Challenge.Konsi.Presentation";
    private const string PERSISTENCE_NAMESPACE = "Challenge.Konsi.Persistence";
    private const string WEB_NAMESPACE = "Challenge.Konsi.Web";
